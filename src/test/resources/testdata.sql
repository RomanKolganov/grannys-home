...
insert into orders (title, description, expirationDate, animal_id, user_id)
values ('Выгул собаки', 'Гулять 2 раза в день. Кормить после каждой прогулки', 14.02.2020, 1, 1);
